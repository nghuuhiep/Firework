...
const letters = "LOVE"; // Define the message you want
...
function createBurst(x, y) {
	const numLetters = letters.length; // Letters in the burst
	const numSparkles = (letters.length * 10) > 80 ? 80 : (letters.length * 10); // Sparkles in the burst for more dramatic effect
	// const numSparkles = (letters.length * 3.5) > 50 ? 50 : (letters.length * 3.5);
	// Letters
